...
import br.com.payment.domain.enums.Perfil;
...
//		Cliente e Endereços
		Cliente cli1 = new Cliente(null, "Maria Silva", "azzolim.fh@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("41 3527-4076", "41 99604-8125"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "azzolimrenan2@gmail.com", "09848213090",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("41 9999-9999", "41 8888-8888"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", "Sala 500", "Centro", "80810050", cli2, c2);
